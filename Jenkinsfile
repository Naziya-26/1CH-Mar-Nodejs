        ...
        stage('SSH to EC2') {
            steps {
                script {
                    ...
                    sh """
                        sshpass -p '${params.SSHPASSWORD}' ssh -p 50022 -o "StrictHostKeyChecking=no" ${params.SSHUSERNAME}@${params.EC2IP} "git clone 'https://github.com/Naziya-26/1CH-Mar-Nodejs.git'"
